        ...
        <main className="main">
          <nav className="main__nav nav">
            <div className="nav__logo logo">
              <Image className="logo__image" src="/public/image/logo.png" alt="" height={250} width={170} />
            </div>
              ...
              <div className="sidebar__list">
                <div className="sidebar__item">
                  <a className="sidebar__link" href="#">
                    <Image
                      ...
                      src="/public/image/playlist01.png"
                      alt="day's playlist"
                ...
                <div className="sidebar__item">
                  <a className="sidebar__link" href="#">
                    <Image
                      className="sidebar__img"
                      src="/public/image/playlist02.png"
                      alt="day's playlist"
                      height={250} width={170}
                    />
                  </a>
                ...
                <div className="sidebar__item">
                  <a className="sidebar__link" href="#">
                    <Image
                      className="sidebar__img"
                      src="/public/image/playlist03.png"
                      alt="day's playlist"
                      height={250} width={170}
                    />
                  </a>
