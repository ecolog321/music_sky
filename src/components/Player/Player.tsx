                            ...
                            <div className={styles.player__track_play}>
                                <div className={styles.track_play__contain}>
                                    ...
                                    <div className={styles.track_play__author}>
                                        <a className={styles.track_play__author_link} href="#">Ты та...</a>
                                    </div>
                                    <div className={styles.track_play__album}>
                                        <a className={styles.track_play__album_link} href="#">Баста</a>
                                    </div>
                                </div>

                                <div className={styles.track_play__dislike}>
                                    <svg className={styles.track_play__dislike_svg}>
                                        <use xlinkHref='/img/icons/sprite.svg#icon-dislike'></use>
                                    </svg>
                                </div>
                            </div>
                        </div>
